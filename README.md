...
Ten permutation techniques (omission, transposition, keyboard adjacency, addition, hyphenation, vowel swap, bitsquatting, dot insertion, TLD swap, homoglyph),
...
scan flags:
      ...
      --technique strings       techniques to run: omission, transposition, keyboard, addition, hyphenation, vowel-swap, bitsquatting, dot-insertion, tld, homoglyph
                                (default: all)
